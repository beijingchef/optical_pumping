...
def render_transition_table_html(df):
    ...
    columns = [
        ...
        ("pump_A1_frequency", "ν<sub>PumpA1</sub>", "MHz", "1f"),
        ("pump_A2_frequency", "ν<sub>PumpA2</sub>", "MHz", "1f"),
        ("pump_B1_frequency", "ν<sub>PumpB1</sub>", "MHz", "1f"),
        ("pump_B2_frequency", "ν<sub>PumpB2</sub>", "MHz", "1f"),
...
def render_zeeman_properties_table_html(df):
    ...
    columns = [
        ...
        ("G^{SE,self} (s^-1)", "G<sup>SE,self</sup>", "s<sup>−1</sup>", ".2f"),
        ("Γ^{SE,self} (s^-1)", "Γ<sup>SE,self</sup>", "s<sup>−1</sup>", ".2f"),
        ("G^{SE,cross} (s^-1)", "G<sup>SE,cross</sup>", "s<sup>−1</sup>", ".2f"),
        ("Γ^{SE,cross} (s^-1)", "Γ<sup>SE,cross</sup>", "s<sup>−1</sup>", ".2f"),
